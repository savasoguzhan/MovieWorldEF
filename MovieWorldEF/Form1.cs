...
namespace MovieWorldEF
{
    public partial class Form1 : Form
    {
        ...
        {
            cbGenra.DataSource = db.Genres.Include(m => m.Movies).ToList();
            cbGenra.DisplayMember= "Name";
            cbGenra.SelectedIndex = 0;
        }
            ...
            var movies = new Movie[]
{
        ...
        private void cbGenra_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbGenra.SelectedIndex == -1)
            {
            ...
            {
                Genre genre = (Genre)cbGenra.SelectedItem;

                dgvMovies.DataSource = genre.Movies.ToList();
            }
        }
